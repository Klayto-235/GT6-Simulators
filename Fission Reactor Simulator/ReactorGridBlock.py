...
class ReactorGridButton(QGraphicsRectItem):
    ...
    def set_label_mid_top(self, text):
        ...
        self.labels[6].setPos(self.x + (self.w - self.labels[6].boundingRect().width()) / 2,
                              self.y + self.h / 2 - self.ofs)
...
class ReactorGridBlock(QGraphicsRectItem):
    ...
    def __init__(self, yp, xp, parent=None):
        ...
        self.buttons_small = [ReactorGridButton(self.x + 2, self.y + 2, (self.w - 8) / 2, (self.w - 8) / 2, 0, 0, self),
                              ReactorGridButton(self.x + 6 + (self.w - 8) / 2, self.y + 2, (self.w - 8) / 2,
                                                (self.w - 8) / 2, 0, 1, self),
                              ReactorGridButton(self.x + 2, self.y + 6 + (self.w - 8) / 2, (self.w - 8) / 2,
                                                (self.w - 8) / 2, 1, 0, self),
                              ReactorGridButton(self.x + 6 + (self.w - 8) / 2, self.y + 6 + (self.w - 8) / 2,
                                                (self.w - 8) / 2, (self.w - 8) / 2, 1, 1, self)]
