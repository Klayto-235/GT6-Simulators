...
RodRecord = namedtuple("RodRecord",
                       ["pixmap", "pixmap_top", "durability", "neutron_emission", "neutron_self", "neutron_max",
                        "neutron_div", "HUperN", "full_name"])
CoolantRecord = namedtuple("CoolantRecord",
                           ["pixmap", "color", "capacity", "temperature", "mod_emission", "mod_self", "mod_max",
                            "mod_div", "moderates", "HU_div", "full_name"])
...
class Assets(metaclass=Singleton):
    ...
    def __init__(self):
        ...
        self.rowcol_util = ["AddColLeft", "AddColRight", "AddRowTop", "AddRowBot", "RemColLeft", "RemColRight",
                            "RemRowTop", "RemRowBot"]
        ...
        self.rod = {
            # pixmap, pixmap_top, durability, neutron_emission, neutron_self, neutron_max, neutron_div, HUperN, full_name
            ...
            "U-238": RodRecord(rod_pixmaps["U-238"], top_pixmaps["U-238"], 50000, 4, 4, 512, 16, (1, 1),
                               "Uranium 238 fuel rod"),
            "U-235": RodRecord(rod_pixmaps["U-235"], top_pixmaps["U-235"], 10000, 32, 32, 2048, 4, (1, 1),
                               "Uranium 235 fuel rod"),
            "U-233": RodRecord(rod_pixmaps["U-233"], top_pixmaps["U-233"], 50000, 32, 32, 2048, 5, (1, 1),
                               "Uranium 233 fuel rod"),
            "Th-232": RodRecord(rod_pixmaps["Th-232"], top_pixmaps["Th-232"], 100000, 2, 2, 128, 32, (1, 1),
                                "Thorium 232 fuel rod"),
            "Co-60": RodRecord(rod_pixmaps["Co-60"], top_pixmaps["Co-60"], 50000, 2, 2, 256, 16, (1, 1),
                               "Cobalt 60 fuel rod"),
            "Pu-244": RodRecord(rod_pixmaps["Pu-244"], top_pixmaps["Pu-244"], 10000, 64, 64, 2048, 4, (1, 1),
                                "Plutonium 244 fuel rod"),
            "Pu-243": RodRecord(rod_pixmaps["Pu-243"], top_pixmaps["Pu-243"], 10000, 128, 128, 4096, 3, (1, 1),
                                "Plutonium 243 fuel rod"),
            "Pu-241": RodRecord(rod_pixmaps["Pu-241"], top_pixmaps["Pu-241"], 10000, 128, 128, 3072, 4, (1, 1),
                                "Plutonium 241 fuel rod"),
            "Pu-239": RodRecord(rod_pixmaps["Pu-239"], top_pixmaps["Pu-239"], 20000, 128, 128, 4096, 3, (1, 1),
                                "Plutonium 239 fuel rod"),
            "Am-245": RodRecord(rod_pixmaps["Am-245"], top_pixmaps["Am-245"], 10000, 64, 64, 4096, 4, (1, 1),
                                "Americium 245 fuel rod"),
            "Am-241": RodRecord(rod_pixmaps["Am-241"], top_pixmaps["Am-241"], 10000, 128, 128, 4096, 3, (1, 1),
                                "Americium 241 fuel rod"),
            "Nq-528": RodRecord(rod_pixmaps["Nq-528"], top_pixmaps["Nq-528"], 100000, 128, 128, 8192, 4, (1, 1),
                                "Enriched Naquadah fuel rod"),
            "Nq-522": RodRecord(rod_pixmaps["Nq-522"], top_pixmaps["Nq-522"], 100000, 512, 512, 16384, 3, (1, 1),
                                "Naquadria fuel rod"),
            "U-238B": RodRecord(rod_pixmaps["U-238B"], top_pixmaps["U-238B"], 288000000, 0, 0, 0, 0, (1, 2),
                                "Uranium 238 breeder rod"),
            "Th-232B": RodRecord(rod_pixmaps["Th-232B"], top_pixmaps["Th-232B"], 144000000, 0, 0, 0, 0, (1, 2),
                                 "Thorium 232 breeder rod")
        }
        ...
        self.material_costs = {
            ...
            "Nuclear Reactor Core (1x1)": {"Dense Lead Machine Casing": 1, "Compact Electric Piston (EV)": 1,
                                           "Crystal Processor (Ruby)": 1},
            "Nuclear Reactor Core (2x2)": {"Dense Lead Machine Casing": 1, "Compact Electric Piston (EV)": 4,
                                           "Crystal Processor (Ruby)": 4},
            ...
            "Compact Electric Piston (EV)": {"Chromium Screw": 2, "Chromium Plate": 2, "Chromium Rod": 2,
                                             "Small Chromium Gear": 1, "Compact Electric Motor (EV)": 1},
            ...
            "Compact Electric Motor (EV)": {"1x Aluminium Cable": 2, "Curved Chromium Plate": 1, "Chromium Rod": 1,
                                            "4x Annealed Copper Wire": 4, "Magnetic Neodymium Rod": 1},
            "1x Aluminium Cable": {"Aluminium Wire": 1, "Rubber Sheet": 1},
            "1x Copper Cable": {"Copper Wire": 1, "Rubber Sheet": 1},
            "Crystal Processor Socket": {"Circuit Plate (Platinum)": 1, "Circuit T6 (Ultimate)": 4,
                                         "Helium-Neon Laser Emitter": 4},
            "Helium-Neon Laser Emitter": {"Helium-Neon Gas": 1, "Circuit T2 (Good)": 1, "Glass": 1, "Silver Plate": 2,
                                          "Stainless Steel Screw": 1, "1x Copper Cable": 2},
            "Circuit T6 (Ultimate)": {"Circuit Plate (Platinum)": 1, "Molten Soldering Alloy": 1,
                                      "Circuit Part (Ultimate)": 4},
            ...
            "Circuit Part (Ultimate)": {"Fine Platinum Wire": 1, "Fine Signalum Wire": 1,
                                        "Tiny Crystalline Redstone Alloy Plate": 1},
            "Circuit Part (Good)": {"Fine Copper Wire": 1, "Fine Red Alloy Wire": 1,
                                    "Tiny Crystalline Silicon Plate": 1}
        }
        ...
        coolant_stencil = QBitmap.fromPixmap(QPixmap("img/coolant_stencil.png", None,
        ...
        self.coolant = {
            # pixmap, color, capacity, temperature, mod_emission, mod_self, mod_max, mod_div, moderates, HU_div, full_name
            "None": CoolantRecord(coolant_pixmaps[0], coolant_colors[0], 0, -1, (1, 1), (1, 1), (1, 1), (mul, 1), False,
                                  1, "No coolant"),
            "IC2": CoolantRecord(coolant_pixmaps[1], coolant_colors[1], 20, 1200, (4, 1), (4, 1), (1, 1), (mul, 2),
                                 False, 1, "IC2 coolant"),
            "Na": CoolantRecord(coolant_pixmaps[2], coolant_colors[2], 30, 1100, (1, 1), (1, 1), (1, 1), (mul, 1),
                                False, 6, "Sodium (Na)"),
            "Sn": CoolantRecord(coolant_pixmaps[3], coolant_colors[3], 40, 2800, (1, 1), (1, 1), (1, 1), (mul, 1),
                                False, 3, "Tin (Sn)"),
            "D2O": CoolantRecord(coolant_pixmaps[4], coolant_colors[4], 50, 600, (1, 1), (1, 1), (1, 1), (mul, 1), True,
                                 1, "Heavy water (D2O)"),
            "DHO": CoolantRecord(coolant_pixmaps[5], coolant_colors[5], 40, 550, (1, 1), (1, 1), (1, 1), (mul, 1), True,
                                 1, "Semiheavy water (DHO)"),
            "T2O": CoolantRecord(coolant_pixmaps[6], coolant_colors[6], 60, 650, (1, 1), (1, 1), (1, 1), (mul, 1), True,
                                 1, "Tritiated water (T2O)"),
            "H2O": CoolantRecord(coolant_pixmaps[7], coolant_colors[7], 80, 420, (1, 1), (1, 1), (1, 1), (mul, 1), True,
                                 1, "Distilled water (H2O)"),
            "CO2": CoolantRecord(coolant_pixmaps[8], coolant_colors[8], 20, 950, (1, 1), (3, 1), (1, 1), (add, -1),
                                 False, 1, "Carbon Dioxide (CO2)"),
            "He": CoolantRecord(coolant_pixmaps[9], coolant_colors[9], 30, 1150, (1, 2), (4, 1), (1, 1), (add, 1),
                                False, 1, "Helium (He)"),
            "LiCl": CoolantRecord(coolant_pixmaps[10], coolant_colors[10], 15, 1600, (1, 2), (5, 1), (5, 4), (mul, 1),
                                  False, 1, "Lithium Chloride (LiCl)"),
            "Th": CoolantRecord(coolant_pixmaps[11], coolant_colors[11], 10000, -1, (1, 2), (0, 1), (4, 1), (add, -1),
                                False, 1, "Thorium salts (Th)")
        }
