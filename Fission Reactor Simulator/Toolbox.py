...
class ToolboxTop(QWidget):
    ...
    def set_size_label(self, width, height):
        self.size_label.setText(
            "".rjust(3 - len(str(width)), ' ') + "   Grid size: " + str(width) + " x " + str(height) + "   " + "".rjust(
                3 - len(str(height)), ' '))
    ...
    def create_toolbar_right(self):
        ...
        self.twin_checkbox_grid.checkbox_top.setToolTip(
            "Automatically grow reactor grid if anything is placed at the edge.")
        ...
        self.twin_checkbox_simulation.checkbox_bottom.setToolTip(
            "Stop the simulation when a rod incurs durability penalty.")
    ...
    def create_toolbar_left(self):
        ...
        for i in range(4):
            ...
            resize_buttons[i].button_top.setToolTip(
                "Add " + temptt[i] + " (" + resize_buttons[i].button_top.shortcut().toString() + ")")
            resize_buttons[i].button_bot.setToolTip(
                "Remove " + temptt[i] + " (" + resize_buttons[i].button_bot.shortcut().toString() + ")")
