...
class ReactorSlot extends React.Component {
    ...
    render() {
		const showProgress = !["Ref", "Abs", "Mod", "None"].includes(this.props.rod);
        return (
            <button tabIndex={-1} onClick={this.props.onClick} onMouseDown={this.onMouseDown} className={this.props.checked ? "checked" : ""}
					style={{backgroundColor: this.props.color}}>
				<span style={{width: 60*this.props.progress, height: showProgress ? 10 : 0}}/>
				<span style={{width: 60 - 60*this.props.progress, height: showProgress ? 10 : 0}}/>
...
class ReactorBlock extends React.Component {
	...
	render() {
		...
		let color = hasCoolant ? assets.coolantColors[this.props.coolant] : null;
		return (
			...
			<span style={{height: hasCoolant ? 10 : 0}}>{this.props.label}</span>
				<ReactorSlot onClick={this.props.onClick.bind(null, 0)} checked={this.props.checked == 0} rod={this.props.rods[0]}
					progress={this.props.progress[0]} label1={this.props.labels1[0]} label2={this.props.labels2[0]} color={color}/>
                <ReactorSlot onClick={this.props.onClick.bind(null, 1)} checked={this.props.checked == 1} rod={this.props.rods[1]}
					progress={this.props.progress[1]} label1={this.props.labels1[1]} label2={this.props.labels2[1]} color={color}/>
                <br/>
                <ReactorSlot onClick={this.props.onClick.bind(null, 2)} checked={this.props.checked == 2} rod={this.props.rods[2]}
					progress={this.props.progress[2]} label1={this.props.labels1[2]} label2={this.props.labels2[2]} color={color}/>
                <ReactorSlot onClick={this.props.onClick.bind(null, 3)} checked={this.props.checked == 3} rod={this.props.rods[3]}
					progress={this.props.progress[3]} label1={this.props.labels1[3]} label2={this.props.labels2[3]} color={color}/>
			</ReactorBlockStyle>
		);
	}
}
